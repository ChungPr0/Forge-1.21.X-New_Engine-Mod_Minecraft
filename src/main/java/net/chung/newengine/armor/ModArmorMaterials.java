...
public class ModArmorMaterials {
    public static final Holder<ArmorMaterial> UNKNOWNRITE_ARMOR_MATERIAL = register("unknownrite", Util.make(new EnumMap<>(ArmorItem.Type.class),
            attribute -> {
            ...
            }), 20, 5f, 0.3f, () -> ModItems.UNKNOWNRITE_INGOT.get());

    private static Holder<ArmorMaterial> register(String name, EnumMap<ArmorItem.Type, Integer> typeProtection,
                                                  int enchantability, float toughness, float knockbackResistance,
                                                  Supplier<Item> ingredientItem) {
        ResourceLocation location = ResourceLocation.fromNamespaceAndPath(NewEngine.MOD_ID, name);
