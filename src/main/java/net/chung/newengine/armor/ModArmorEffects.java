...
public class ModArmorEffects extends ArmorItem {
    private static final Map<Holder<ArmorMaterial>, List<MobEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<Holder<ArmorMaterial>, List<MobEffectInstance>>())
                    .put(ModArmorMaterials.UNKNOWNRITE_ARMOR_MATERIAL,
                            List.of(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 10000, 1, false, false, false)))
                    .build();

    public ModArmorEffects(Holder<ArmorMaterial> material, Type type, Properties properties) {
