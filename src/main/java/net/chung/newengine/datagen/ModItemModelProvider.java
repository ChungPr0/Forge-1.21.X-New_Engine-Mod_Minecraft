...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        trimmedArmorItem(ModItems.UNKNOWN_HELMET);
        trimmedArmorItem(ModItems.UNKNOWN_CHESTPLATE);
        trimmedArmorItem(ModItems.UNKNOWN_LEGGINGS);
        trimmedArmorItem(ModItems.UNKNOWN_BOOTS);
    }

    // Shoutout to El_Redstoniano for making this
    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        final String MOD_ID = NewEngine.MOD_ID; // Change this to your mod id
        ...
        if(itemRegistryObject.get() instanceof ArmorItem armorItem) {
            trimMaterials.forEach((trimMaterial, value) -> {
                ...
                getBuilder(currentTrimName)
                        ...
                        .texture("layer0", armorItemResLoc.getNamespace() + ":item/armor/" + armorItemResLoc.getPath())
    ...
    private ItemModelBuilder handheldItem(RegistryObject<Item> item) {
        return withExistingParent(item.getId().getPath(),
                ...
                ResourceLocation.fromNamespaceAndPath(NewEngine.MOD_ID, "item/tool/" + item.getId().getPath()));
    }
}